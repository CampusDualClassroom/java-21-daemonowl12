...
public class Exercise21 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Añadiendo ELEMENT AAA al HashSet: " + addElementToSet(hashSet, "ELEMENT AAA"));
        System.out.println("Añadiendo ELEMENT AAA al TreeSet: " + addElementToSet(treeSet, "ELEMENT AAA"));
